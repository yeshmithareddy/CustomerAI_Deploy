...
def Demand():
    ...
    with upper_panel:
        ...
        result = final_df[["STOCK_CODE","DEPARTMENT","CATEGORY","STOCK_NAME","UNITS_SOLD_FOR_WEEK3","UNITS_SOLD_FOR_WEEK2","UNITS_SOLD_FOR_WEEK1","NEXT_WEEK_PREDICTION"]]
        fig = go.Figure(data=[go.Table(columnwidth=[1.2,2,2,2.4,2,2,2,2],header=dict(values=("<b>STOCK CODE<b>","<b>DEPARTMENT<b>","<b>CATEGORY<b>","<b>STOCK NAME<b>","<b>UNITS SOLD WEEK3<b>","<b>UNITS SOLD WEEK2<b>","<b>UNITS SOLD WEEK1<b>","<b>NEXT WEEK PREDICTION<b>"), fill_color='#00568D', font_color="#ffffff", align=['center'], line_color='#ffffff', font_size = 13,height=35),cells=dict(values=[result.STOCK_CODE,result.DEPARTMENT,result.CATEGORY,result.STOCK_NAME,result.UNITS_SOLD_FOR_WEEK3,result.UNITS_SOLD_FOR_WEEK2,result.UNITS_SOLD_FOR_WEEK1,result.NEXT_WEEK_PREDICTION],fill_color = [['white','lightgrey']*3200], align=['left'], font_size = 12))])
