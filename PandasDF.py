...
snow_df_dmd=session.table('CUSTOMERAI_DB.MAIN.VW_DEMAND_FORECASTING_RESULTS')
snow_df_prc=session.table('CUSTOMERAI_DB.MAIN.VW_PRICING_RESULTS')
...
pd_df_dmd = snow_df_dmd.to_pandas()
pd_df_prc=snow_df_prc.to_pandas()
